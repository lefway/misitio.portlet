...
from misitio.portlet import ExamplePortletMessageFactory as _
...
class IExamplePortlet(IPortletDataProvider):
    ...
    nombre_usuario = schema.TextLine(title=_(u"Nombre del Usuario"),
                                 description=_(u"nombre del usuario"),
                                 required=True)

    asunto_correo = schema.TextLine(title=_(u"Asunto Correo"),
                                 description=_(u"asunto correo"),
                                 required=True)
...
class Assignment(base.Assignment):
    ...
    def __init__(self, nombre_usuario=u"",asunto_correo=u""):
       self.nombre_usuario = nombre_usuario
       self.asunto_correo = asunto_correo
    # def __init__(self):
    #    pass
